...
def splitData(csv:str, k:int) -> list[np.array]:
    """
    Input:
    ...
    # if (partition == k):
    #     new_array = new_array[:k-1]
    #     return [new_array,test_fold]
    # else:
    #     left_side = new_array[:partition-1]
    #     right_side = new_array[partition:]
    #     return [left_side, right_side, test_fold]
